...
At a distance of 1 meters, an object with a size of at least \todo{size of what we can hit at 1 meters distance} centimeters in diameter can be tracked with a good amount of precision.
...
\todo{finish writing about test cases when we are done playing with flat}

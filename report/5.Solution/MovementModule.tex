...
The move method makes use of the helper method \texttt{get\_speed\_by\_distance}, as seen on Snippet~\ref{lst:getspeed}, which gets the speed at which the motors should move.

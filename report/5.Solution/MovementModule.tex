...
When the machine intelligence system has observed and located the target, it will send the information to the NXT which will then begin the movement towards the target.

...
This argument can either be a single \texttt{OutputDevice} or multiple, which is relevant when the user both wants to debug while also transmitting the information to the NXT.

...
When the Raspberry Pi locates a target, this information needs to be transmitted to the NXT and be translated into a power dictates how much the motors should move on the X and Y axis.

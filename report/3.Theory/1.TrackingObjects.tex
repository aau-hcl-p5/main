...
%In order to not just track a flying object in front of the \texttt{F.L.A.T}, it is nessesary to gain a basic understanding of ballistic trajectories in order to predict where the object will be after a given period of time. 
%

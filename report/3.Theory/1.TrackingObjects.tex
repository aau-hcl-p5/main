...
In order to predict the location of a moving object, a keen observation that has to be made is whether the object is flying, meaning that the object is following a ballistic trajectory or if the object is driving i.e{.} following a linear trajectory. 

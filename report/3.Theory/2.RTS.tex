...
The most commonly used task-based scheduler is the fixed-priority scheduling method (FPS), which is based on each task having a fixed priority \cite{RealTimeEmbeddedSystems}.

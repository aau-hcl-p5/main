...
Being scheduable means that all tasks have to be true to their deadlines. 
...
\todo{billede af cyclic executive}
...
The priority of a task can be set by using a model called \textit{fixed priority schedueling}.

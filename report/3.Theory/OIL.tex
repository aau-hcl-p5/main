...
\end{lstlisting}
As seen in the listing above, an event has a mask property, which serves as an identifier for the given event \cite{oil25}.
This can either be manually defined as a 64-bit unsigned int or can be handled by OSEK by using the AUTO keyword.

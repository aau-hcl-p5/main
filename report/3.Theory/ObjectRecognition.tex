...
An improved version is called \textit{faster RCNN}, which is leaning toward being feasible for real time object detection, since it improves the performance of RCNN considerably\cite{fasterRCNN}.
...
Furthermore the performance of YOLO beats that of faster RCNN\cite{odDetection}.

YOLO also uses CNN like RCNN, but takes a fundamentally different approach to the object detection.

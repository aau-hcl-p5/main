...
\begin{minipage}[T]{0.45\textwidth}
 ...
 \begin{flushleft}
  \textbf{Abstract:}\\
    ...
    The report explores the theory behind using a camera for image recognition and possibilities to implement machine intelligence for the purpose as well as how schedueling for a real-time system works, and how it can be implemented using the OSEK standard.

...
Based on these takeaways, and the initial problem in \autoref{key:initialProblem}, a concrete problem statement can be formulated:\\~\\
...
As the assigned group room primarily have white walls, a good option is red.

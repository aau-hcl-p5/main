...
%føler ikke at vores requirements overhovedet er related til studieordningen. For den siger vitterligt bare: embedded device, med MI og/eller RTS.
\subsection{Naming}
...
\todo{Er problem statment problem faktisk en ting?}
...
\todo{fix vores balloon size, tror ikke size skal være på}

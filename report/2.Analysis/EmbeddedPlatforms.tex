...
The Raspberry Pi, as shown on \autoref{fig:raspberrypi}, is a single-board computer ecosystem which, like the Arduino, consists of small computers with GPIO pins.

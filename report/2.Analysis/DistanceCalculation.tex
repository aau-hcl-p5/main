...
Relying on projectiles and guns can introduce uncertainty and based challenges, in a project that already seems difficult from a software perspective, which is not ideal.
%based challenges?

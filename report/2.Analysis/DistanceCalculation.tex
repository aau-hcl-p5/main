...
A more expensive solution would be using a 3D camera, but as these are relatively expensive for a project of this size, this option will not be explored any further.

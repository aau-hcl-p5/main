\section{Hardware}\label{des:sec:hwtest}
...
\subsection*{Laser}
The laser is an essential part of the project and will hence be deemed a critical part of the system.
The criteria for the laser is that when asked to turn on the laser should turn on and continue until told otherwise. 
In order to verify that the laser works according to this criteria the laser was tested with a controlled current delivered by an external power supply based on the  RaspberryPi and Arduino platforms since why can both can deliver 5 Volt of direct current\cite{RaspberryPi}\cite{ArduinoUno}.
The laser module was latter attached to the LEGO NXT and the laser module operated with the same effect as earlier tests. 

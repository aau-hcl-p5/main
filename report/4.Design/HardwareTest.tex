...
To test, the Raspberry Pi and Arduino platforms were used, since both can deliver 5 volts of direct current, which is the required amount for the laser\cite{RaspberryPi}\cite{ArduinoUno}\cite{LaserDatasheet}.

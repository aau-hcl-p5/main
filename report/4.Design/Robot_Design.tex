...
Once the base of the robot has been crafted, the turret can be developed in order to achieve the design criteria of \textit{correctness} and \textit{robustness}, in order to fulfill the must have requirement regarding structural stability from the MoSCoW analysis, conducted in Subsection~\ref{subsec:requirements}. 

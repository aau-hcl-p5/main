...
\textit{Simplicity} meaning that the robot should be as simple in its design as possible, to reduce the amount of work required from the project group, and allow for expansion. 

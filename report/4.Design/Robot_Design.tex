...
With \textit{robustness} meaning that the robot should be sturdy during the movement of the robot.
...
Finally, the robot must be able to move correct, according to the information delivered to the robot, thus making the correctness criteria essential. 
...
Since the project is based on the LEGO NXT and its associated motors, the simple solution is to make the base with standard LEGO Technic parts made available by the university. 
...
There were a multiple problems with this early design, first of all, the top part of the turret was not stable enough for the robot to achieve the wanted \textit{robustness}.

...
The most obvious option, and the option that was expected to be applied from the beginning, is object localization.
...
However, as the target trajectory prediction method also requires object classification, it will not be looked further into at this moment.
The method deemed most suitable to be working with is object localization.
In the following section, the different methods of applying object localization, as well as testing the performance on the hardware platform will be looked into.

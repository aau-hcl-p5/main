...
Predicting the future location of the target.
...
That means the movement of the target is relatively predictable, and not prone to make diverging movements from its current path.
...
However, as hitting the target with a projectile, has been deemed out of scope, it is irrelevant in the scope of this project.

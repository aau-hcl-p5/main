...
This data is calculated on the Raspberry Pi host and the structure then transferred onto the NXT.
...
The structures uses the packed attribute in order to keep the size at 4 bytes, and 3 status codes are defined with information about whether a target has been found, and whether the host has requested to terminate the connection.

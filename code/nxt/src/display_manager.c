...
void display_target_information(STATUS_CODE status_code, T_VECTOR target_last_location) {
    ...
    display_int_at_xy(3, 5, get_speed_by_distance(target_last_location.x, AXIS_X), 4);
    display_string_at_xy(9, 5, "Y:");
    display_int_at_xy(12, 5, get_speed_by_distance(target_last_location.y, AXIS_Y), 4);

...
const TaskType Task_ts1 = 0;
const TaskType Task_background = 1;

extern void TASKNAME( Task_ts1 )( void );
extern void TASKNAME( Task_background )( void );

static __STK_UNIT _stack_Task_ts1[__TCOUNT_STK_UNIT(512)];
...
const AppModeType tinib_autoact[TNUM_TASK] = { 0x00000000, 0x00000001, };
const FP tinib_task[TNUM_TASK] = { TASKNAME( Task_ts1 ), TASKNAME( Task_background ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Task_ts1, (__STK_UNIT)_stack_Task_background, };
...
const Priority resinib_ceilpri[TNUM_RESOURCE] = { TPRI_MINTASK + 2, };
